      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden transition-all duration-300 hover:shadow-2xl">
          ...
          <div className="bg-green-600 py-4 px-6">
            <h2 className="text-2xl font-bold text-white text-center">Join GoGreen</h2>
            <p className="text-green-100 text-center mt-1">Create your eco-friendly account</p>
          </div>
          ...
          <div className="p-6 sm:p-8">
            ...
            <div className="mt-6">
              ...
              <div className="mt-6 grid grid-cols-3 gap-3">
                ...
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M10 0C4.477 0 0 4.477 0 10c0 5.523 4.477 10 10 10 5.523 0 10-4.477 10-10 0-5.523-4.477-10-10-10zm3 8v-2H8v2h5zm0 2H8v2h5v-2z" />
                  </svg>
                </button>
              </div>
            </div>
